...
bool WidgetUtils::setShape(HWND hWnd, const sf::Image& image) {
...
bool WidgetUtils::setTransparency(HWND hWnd, unsigned char alpha) {
...
//
//bool WidgetUtils::setShape(Window wnd, const sf::Image& image) {
//	const sf::Uint8* pixelData = image.getPixelsPtr();
...
//}
//
//bool WidgetUtils::setTransparency(Window wnd, unsigned char alpha) {
//	Display* display = XOpenDisplay(NULL);
...
////	bool WidgetUtils::setShape(sf::WindowHandle handle, const sf::Image& image);
////	bool WidgetUtils::setTransparency(sf::WindowHandle handle, unsigned char alpha);
//#else
//bool WidgetUtils::setShape(sf::WindowHandle handle, const sf::Image& image) {
//	return false;
//}
